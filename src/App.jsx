    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path='/Inicio' element={[
             ...
             <VideoTransmision key={5} videoUrl="https://www.youtube.com/watch?v=yYMEMTZp2QA&ab_channel=DonOmarNation" scheduledTime="15:20" videoDuration={3.49}/>, //isLive={true} para video en vivo(quitar videoDuration)
        ...
        <Route path='/Rifa'
           element = {[
            <div key={1} className='cont-app-reloj'><Reloj type='rifa' dateRifa='03/23/2025' horaRifa='18:00' /></div>,
